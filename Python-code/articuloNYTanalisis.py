...
# y damos a los campos unos nombres más legibles y destacados:
import pandas as pd  # Importamos la librería Pandas de Python, destinada al análisis de datos, que nos proporciona la estructura dataframe
...
df.tail()
# Exportamos los datos a un fichero CSV, que se ubicará en el mismo directorio donde reside este fichero python:
